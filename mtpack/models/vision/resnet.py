...
class Shortcut(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.cat([x, torch.zeros(*s, device=x.device, dtype=x.dtype)], dim=1)
...
class CifarResNet(nn.Sequential):
    def __init__(self, params, num_classes=10, **kwargs):
        ...
        for out_channels, num_blocks, strides in params:
            for stride in [strides] + [1] * (num_blocks - 1):
                if stride != 1 or in_channels != out_channels:
                    shortcut = Shortcut(stride=stride, out_channels=out_channels)
                else:
                    shortcut = None
...
def resnet20(num_classes=10):
    return CifarResNet(params=[(16, 3, 1), (32, 3, 2), (64, 3, 2)], num_classes=num_classes)


def resnet32(num_classes=10):
    return CifarResNet(params=[(16, 5, 1), (32, 5, 2), (64, 5, 2)], num_classes=num_classes)


def resnet44(num_classes=10):
    return CifarResNet(params=[(16, 7, 1), (32, 7, 2), (64, 7, 2)], num_classes=num_classes)


def resnet56(num_classes=10):
    return CifarResNet(params=[(16, 9, 1), (32, 9, 2), (64, 9, 2)], num_classes=num_classes)


def resnet110(num_classes=10):
    return CifarResNet(params=[(16, 18, 1), (32, 18, 2), (64, 18, 2)], num_classes=num_classes)


def resnet1202(num_classes=10):
    return CifarResNet(params=[(16, 200, 1), (32, 200, 2), (64, 200, 2)], num_classes=num_classes)
